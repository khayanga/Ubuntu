    ...
    return (
      <Card className="border-none shadow-xl bg-white dark:bg-gray-800/50 backdrop-blur-sm overflow-hidden h-full">
        <CardContent className="p-8 relative h-full flex flex-col">
          <div className="absolute -top-6 -left-6 w-16 h-16 text-sky-100 dark:text-sky-900/50 opacity-60">
          ...
          <div className="flex items-center border-t border-gray-100 dark:border-gray-700/50 pt-4 mt-auto">
            <div className="w-10 h-10 bg-sky-100 dark:bg-sky-900/30 rounded-full flex items-center justify-center text-sky-600 dark:text-sky-400 mr-3">
              <User size={18} />
            </div>
            <div>
        ...
        <div className=" relative z-10">
          ...
          >
            ...
            <div className="flex justify-center mt-10 gap-2">
              <CarouselPrevious className=" static -translate-y-0 h-10 w-10 rounded-full border-sky-200 text-sky-700 hover:bg-sky-50 dark:border-sky-800 dark:text-sky-400 dark:hover:bg-sky-900/20" />
              <CarouselNext className="static -translate-y-0 h-10 w-10 rounded-full border-sky-200 text-sky-700 hover:bg-sky-50 dark:border-sky-800 dark:text-sky-400 dark:hover:bg-sky-900/20" />
            </div>
          </Carousel>
