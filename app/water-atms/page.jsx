  ...
  return (
    <div className="bg-gray-900 w-full min-h-screen">
        ...
        <div className='flex flex-col md:flex-row  items-center justify-between px-4 gap-4 md:gap-10 pb-2'>
            <div className=' flex flex-col space-y-6  w-1/2 p-2'>
        ...
        <div className=' container mx-auto  flex flex-col md:flex-row  items-center justify-between px-4 gap-4 pb-2'>
        {pricingData.map((plan,index) => (
          ...
          >
            ...
            <CardContent className="text-white">
              ...
              <p className='text-sm text-gray-800'>{plan.title}</p>
            </CardContent>
          </Card>
        ))}
        </div>
